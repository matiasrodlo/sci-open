...
const unpaywall_1 = require("../sources/unpaywall");
const unpaywallConnector = new unpaywall_1.UnpaywallConnector(process.env.UNPAYWALL_EMAIL || 'your-email@example.com');
...
function candidatesFromEuropePMC(record) {
...
function candidateFromOpenAIRE(record) {
...
function candidateFromPLOS(record) {
